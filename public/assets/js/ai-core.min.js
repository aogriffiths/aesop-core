!function(a) {
    ...
    c.swipebox = function(e, f) {
        ...
        j.settings = {}, j.init = function() {
            j.settings = c.extend({}, i, f), c.isArray(e) ? (k = e, g.target = c(a), g.init(j.settings.initialIndexOnArray)) : c(b).on("click", l, function(a) {
                ...
                h.each(function() {
                    var a = null, b = null;
                    c(this).attr("title") && (a = c(this).attr("title")), c(this).attr("href") && (b = c(this).attr("href")), 
                    k.push({
                        href: b,
                        title: a
                    });
                }), b = h.index(c(this)), a.preventDefault(), a.stopPropagation(), g.target = c(a.target), 
                g.init(b);
            });
        }, g = {
            init: function(a) {
                j.settings.beforeOpen && j.settings.beforeOpen(), this.target.trigger("swipebox-start"), 
                c.swipebox.isOpen = !0, this.build(), this.openSlide(a), this.openMedia(a), this.preloadMedia(a + 1), 
                this.preloadMedia(a - 1), j.settings.afterOpen && j.settings.afterOpen();
            },
            build: function() {
                var a, b = this;
                c("body").append(s), b.doCssTrans() && (c("#swipebox-slider").css({
                    ...
                    transition: "0.5s"
                })), p && j.settings.useSVG === !0 && (a = c("#swipebox-action #swipebox-close").css("background-image"), 
                a = a.replace("png", "svg"), c("#swipebox-action #swipebox-prev,#swipebox-action #swipebox-next,#swipebox-action #swipebox-close").css({
                    "background-image": a
                })), n && j.settings.hideBarsOnMobile === !0 && c("#swipebox-action, #swipebox-caption").hide(), 
                c.each(k, function() {
            ...
            setDim: function() {
                ...
                "onorientationchange" in a ? a.addEventListener("orientationchange", function() {
                    0 === a.orientation ? (b = q, d = r) : (90 === a.orientation || -90 === a.orientation) && (b = r, 
                    d = q);
            ...
            gesture: function() {
                ...
                k.addClass("visible-bars"), a.setTimeout(), c("body").bind("touchstart", function(a) {
                    return c(this).addClass("touching"), i = a.originalEvent.targetTouches[0], h.pageX = a.originalEvent.targetTouches[0].pageX, 
                    h.pageY = a.originalEvent.targetTouches[0].pageY, c(".touching").bind("touchmove", function(a) {
                        if (a.preventDefault(), a.stopPropagation(), i = a.originalEvent.targetTouches[0], 
                        j.settings.closeBySwipe && (d = i.pageY - h.pageY, Math.abs(d) >= g || e)) {
                    ...
                    b = i.pageX - h.pageX, b >= f ? a.getPrev() : -f >= b ? a.getNext() : k.hasClass("visible-bars") ? (a.clearTimeout(), 
                    a.hideBars()) : (a.showBars(), a.setTimeout()), c(".touching").off("touchmove").removeClass("touching");
                });
            },
            setTimeout: function() {
            ...
            setSlide: function(a, b) {
                ...
                this.doCssTrans() ? d.css({
                    ...
                    left: 100 * -a + "%"
                }), c("#swipebox-slider .slide").removeClass("current"), c("#swipebox-slider .slide").eq(a).addClass("current"), 
                this.setTitle(a), b && d.fadeIn(), c("#swipebox-prev, #swipebox-next").removeClass("disabled"), 
                0 === a ? c("#swipebox-prev").addClass("disabled") : a === k.length - 1 && c("#swipebox-next").addClass("disabled");
            },
            openSlide: function(b) {
                c("html").addClass("swipebox-html"), o && c("html").addClass("swipebox-touch"), 
                c(a).trigger("resize"), this.setSlide(b, !0);
            },
            ...
            getNext: function() {
                ...
                b + 1 < k.length ? (b++, a.setSlide(b), a.preloadMedia(b + 1)) : (c("#swipebox-slider").addClass("rightSpring"), 
                setTimeout(function() {
            ...
            getPrev: function() {
                ...
                a > 0 ? (a--, this.setSlide(a), this.preloadMedia(a - 1)) : (c("#swipebox-slider").addClass("leftSpring"), 
                setTimeout(function() {
                    c("#swipebox-slider").removeClass("leftSpring");
                }, 500));
            },
            closeSlide: function() {
                c("html").removeClass("swipebox-html"), c("html").removeClass("swipebox-touch"), 
                c(a).trigger("resize"), this.destroy();
            },
            destroy: function() {
                c(a).unbind("keyup"), c("body").unbind("touchstart"), c("body").unbind("touchmove"), 
                c("body").unbind("touchend"), c("#swipebox-slider").unbind(), c("#swipebox-overlay").remove(), 
                c.isArray(e) || e.removeData("_swipebox"), this.target && this.target.trigger("swipebox-destroy"), 
                c.swipebox.isOpen = !1, j.settings.afterClose && j.settings.afterClose();
            }
        }, j.init();
...
}.call(this), fotoramaVersion = "4.6.2", function(a, b, c, d, e) {
    "use strict";
    function f(a) {
    ...
    function t(a) {
        ...
        if (!b.tEnd) {
            ...
            T(c, d[ub.prefixed("transition")], function(a) {
    ...
    function D(a) {
        ...
        return a.children().each(function() {
            var a = d(this), f = R(d.extend(a.data(), {
                id: a.attr("id")
            }));
    ...
    function G(a, b, c, d) {
        return G.i || (G.i = 1, G.ii = [ !0 ]), d = d || G.i, "undefined" == typeof G.ii[d] && (G.ii[d] = !0), 
    ...
    function I(a, b, c, d) {
        ...
        if (f && (!e.l || e.l.W !== f.width || e.l.H !== f.height || e.l.r !== f.ratio || e.l.w !== b.w || e.l.h !== b.h || e.l.m !== c || e.l.p !== d)) {
            ...
            k && (l || m) || !k && n ? (g = h(b.w, 0, l ? g : 1 / 0), i = g / f.ratio) : (k && n || !k && (l || m)) && (i = h(b.h, 0, l ? i : 1 / 0), 
            g = i * f.ratio), a.css({
                width: Math.ceil(g),
                height: Math.ceil(i),
    ...
    function aa(a, b, c, e, f, h) {
        ...
        if (i || (f.push(arguments), Array.prototype.push.call(arguments, f.length), !(f.length > 1))) {
            ...
            c.removeClass(Ra + " " + Qa), a.stop().addClass(Ra), b.stop().addClass(Qa), l && k && a.fadeTo(0, 0), 
    ...
    function ca(a, c) {
        function e(a) {
            return m = d(a.target), u.checked = p = q = s = !1, k || u.flow || a.touches && a.touches.length > 1 || a.which > 1 || ec && ec.type !== a.type && gc || (p = c.select && m.is(c.select, t)) ? p : (o = "touchstart" === a.type, 
            q = m.is("a, a *", t), n = u.control, r = u.noMove || u.noSwipe || n ? 16 : u.snap ? 0 : 4, 
            ba(a), l = ec = a, fc = a.type.replace(/down|start/, "move").replace(/Down/, "Move"), 
        ...
        function f(a) {
            if (a.touches && a.touches.length > 1 || Nb && !a.isPrimary || fc !== a.type || !k) return k && h(), 
            void (c.onTouchEnd || g)();
            ba(a);
        ...
        function h(a) {
            (c.onTouchEnd || g)();
            var b = k;
            u.control = k = !1, b && (u.flow = !1), !b || q && !u.checked || (a && Y(a), gc = !0, 
            clearTimeout(hc), hc = setTimeout(function() {
                gc = !1;
        ...
        return Nb ? (T(t, "MSPointerDown", e), T(b, "MSPointerMove", f), T(b, "MSPointerCancel", h), 
        T(b, "MSPointerUp", h)) : (T(t, "touchstart", e), T(t, "touchmove", f), T(t, "touchend", h), 
        T(b, "touchstart", i), T(b, "touchend", j), T(b, "touchcancel", j), Eb.on("scroll", j), 
        a.on("mousedown", e), Fb.on("mousemove", f).on("mouseup", h)), a.on("click", "a", function(a) {
            u.checked && Y(a);
        }), u;
    }
    function da(a, b) {
        function c(c, d) {
            A = !0, j = l = c._x, q = c._now, p = [ [ q, j ] ], m = n = D.noMove || d ? 0 : v(a, (b.getPos || g)()), 
        ...
        function f(d, e) {
            D.noSwipe || (A || c(d), l = d._x, p.push([ d._now, l ]), n = m - (j - l), o = K(n, s, t), 
            s >= n ? n = x(n, s) : n >= t && (n = x(n, t)), D.noMove || (a.css(k(n)), z || (z = !0, 
            e.touch || Nb || a.addClass(eb)), (b.onMove || g).call(B, d, {
                pos: n,
                edge: o
            })));
        }
        function i(e) {
            if (!D.noSwipe || !e.moved) {
                ...
                v = h(n, s, t);
                var H = k - l, I = H >= 0, J = r - C, K = J > Pb, L = !K && n !== m && v === n;
                u && (v = h(Math[L ? I ? "floor" : "ceil" : "round"](n / u) * u, s, t), s = t = v), 
                L && (u || v === n) && (y = -(H / J), E *= h(Math.abs(y), b.timeLow, b.timeHigh), 
                o = Math.round(n + y * E / F), u || (v = o), (!I && o > t || I && s > o) && (q = I ? s : t, 
                x = o - q, u || (v = q), x = h(v + .03 * x, q - 50, q + 50), E = Math.abs((n - x) / (y / F)))), 
                E *= w ? 10 : 1, (b.onEnd || g).call(B, d.extend(e, {
                    moved: e.moved || K && u,
                    pos: n,
                    newPos: v,
                    overPos: x,
    ...
    function ea(a, b) {
        ...
        return T(h, Ob, function(a) {
            var h = a.wheelDeltaY || -1 * a.deltaY || 0, j = a.wheelDeltaX || -1 * a.deltaX || 0, k = Math.abs(j) && !Math.abs(h), l = Z(0 > j), m = e === l, n = d.now(), o = Pb > n - f;
            e = l, f = n, k && i.ok && (!i.prevent[l] || c) && (Y(a, !0), c && m && o || (b.shift && (c = !0, 
    ...
    if ("undefined" != typeof b.cancelFullScreen) vb.ok = !0; else for (var xb = 0, yb = wb.length; yb > xb; xb++) if (vb.prefix = wb[xb], 
    "undefined" != typeof b[vb.prefix + "CancelFullScreen"]) {
        vb.ok = !0;
        break;
    }
    ...
    var Cb, Db, Eb = d(a), Fb = d(b), Gb = "quirks" === c.hash.replace("#", ""), Hb = ub.csstransforms3d, Ib = Hb && !Gb, Jb = Hb || "CSS1Compat" === b.compatMode, Kb = vb.ok, Lb = navigator.userAgent.match(/Android|webOS|iPhone|iPad|iPod|BlackBerry|Windows Phone/i), Mb = !Ib || Lb, Nb = navigator.msPointerEnabled, Ob = "onwheel" in b.createElement("div") ? "wheel" : b.onmousewheel !== e ? "mousewheel" : "DOMMouseScroll", Pb = 250, Qb = 300, Rb = 1400, Sb = 5e3, Tb = 2, Ub = 64, Vb = 500, Wb = 333, Xb = "$stageFrame", Yb = "$navDotFrame", Zb = "$navThumbFrame", $b = "auto", _b = f([ .1, 0, .25, 1 ]), ac = 99999, bc = "50%", cc = {
        width: null,
        minwidth: null,
        maxwidth: "100%",
        height: null,
    ...
    jQuery.Fotorama = function(a, e) {
        ...
        function i(a) {
            var b = "keydown." + ia, c = ia + jd, d = "keydown." + c, f = "resize." + c + " orientationchange." + c;
            a ? (Fb.on(d, function(a) {
                var b, c;
                Cc && 27 === a.keyCode ? (b = !0, mc(Cc, !0, !0)) : (id.fullScreen || e.keyboard && !id.index) && (27 === a.keyCode ? (b = !0, 
                id.cancelFullScreen()) : a.shiftKey && 32 === a.keyCode && g("space") || 37 === a.keyCode && g("left") || 38 === a.keyCode && g("up") ? c = "<" : 32 === a.keyCode && g("space") || 39 === a.keyCode && g("right") || 40 === a.keyCode && g("down") ? c = ">" : 36 === a.keyCode && g("home") ? c = "<<" : 35 === a.keyCode && g("end") && (c = ">>")), 
                (b || c) && Y(a), c && id.show({
                    index: c,
                    slow: a.altKey,
                    user: !0
        ...
        function j(b) {
            b !== j.f && (b ? (a.html("").addClass(ia + " " + kd).append(qd).before(od).before(pd), 
            ga(id)) : (qd.detach(), od.detach(), pd.detach(), a.html(nd.urtext).removeClass(kd), 
            ha(id)), i(b), j.f = b);
        }
        function m() {
            yc = id.data = yc || P(e.data) || D(a), zc = id.size = yc.length, !xc.ok && e.shuffle && O(yc), 
            f(), Jd = y(Jd), zc && j(!0);
        }
        function o() {
            var a = 2 > zc && !e.enableifsingleframe || Cc;
            Md.noMove = a || Sc, Md.noSwipe = a || !e.swipe, !Wc && sd.toggleClass(Ba, !e.click && !Md.noMove && !Md.noSwipe), 
            Nb && qd.toggleClass(sa, !Md.noSwipe);
        }
        function t(a) {
        ...
        function u() {
            ...
            id.options = e = R(e), Sc = "crossfade" === e.transition || "dissolve" === e.transition, 
            Mc = e.loop && (zc > 2 || Sc && (!Wc || "slide" !== Wc)), Vc = +e.transitionduration || Qb, 
            Yc = "rtl" === e.direction, Zc = d.extend({}, e.keyboard && dc, e.keyboard);
            var b = {
                add: [],
                remove: []
            };
            zc > 1 || e.enableifsingleframe ? (Nc = e.nav, Pc = "top" === e.navposition, b.remove.push(Xa), 
            wd.toggle(!!e.arrows)) : (Nc = !1, wd.hide()), Ra(), Bc = new zb(d.extend(Ab, e.spinner, Bb, {
                direction: Yc ? -1 : 1
            })), Gb(), Hb(), e.autoplay && t(e.autoplay), Tc = n(e.thumbwidth) || Ub, Uc = n(e.thumbheight) || Ub, 
            Nd.ok = Pd.ok = e.trackpad && !Mb, o(), ec(e, [ Ld ]), Oc = "thumbs" === Nc, Oc ? (lb(zc, "navThumb"), 
            Ac = Bd, hd = Zb, J(od, d.Fotorama.jst.style({
                w: Tc,
                h: Uc,
                ...
                s: jd,
                q: !Jb
            })), yd.addClass(La).removeClass(Ka)) : "dots" === Nc ? (lb(zc, "navDot"), Ac = Ad, 
            hd = Yb, yd.addClass(Ka).removeClass(La)) : (Nc = !1, yd.removeClass(La + " " + Ka)), 
            Nc && (Pc ? xd.insertBefore(rd) : xd.insertAfter(rd), wb.nav = !1, wb(Ac, zd, "nav")), 
            Qc = e.allowfullscreen, Qc ? (Dd.prependTo(rd), Rc = Kb && "native" === Qc) : (Dd.detach(), 
            Rc = !1), a(Sc, oa), a(!Sc, pa), a(!e.captions, va), a(Yc, ta), a("always" !== e.arrows, wa), 
            Xc = e.shadows && !Mb, a(!Xc, ra), qd.addClass(b.add.join(" ")).removeClass(b.remove.join(" ")), 
            Kd = d.extend({}, e);
        }
        function x(a) {
        ...
        function U(a) {
            return zc - 1 > a || Mc ? a + 1 : !1;
        }
        function $() {
            Md.min = Mc ? -1 / 0 : -r(zc - 1, Ld.w, e.margin, Fc), Md.max = Mc ? 1 / 0 : -r(0, Ld.w, e.margin, Fc), 
            Md.snap = Ld.w + e.margin;
        }
        function ba() {
        ...
        function fa(a, b, c, d) {
            (!$c || "*" === $c && d === Lc) && (a = q(e.width) || q(a) || Vb, b = q(e.height) || q(b) || Wb, 
            id.resize({
                width: a,
                ratio: e.ratio || c || a / b
            }, 0, d !== Lc && "*"));
        ...
        function Pa(a, b, c, f, g, h) {
            ca(a, b, function(a, i, j, k, l, m) {
                ...
                function o() {
                    t.remove(), d.Fotorama.cache[w] = "error", j.html && "stage" === b || !y || y === w ? (!w || j.html || r ? "stage" === b && (k.trigger("f:load").removeClass(ab + " " + _a).addClass(bb), 
                    n("load"), fa()) : (k.trigger("f:error").removeClass(ab).addClass(_a), n("error")), 
                    m.state = "error", !(zc > 1 && yc[i] === j) || j.html || j.deleted || j.video || r || (j.deleted = !0, 
                    id.splice(i, 1))) : (j[v] = w = y, Pa([ i ], b, c, f, g, !0));
                }
                function p() {
                    ...
                    }, fa(u.measures.width, u.measures.height, u.measures.ratio, i), t.off("load error").addClass(fb + (r ? " " + gb : "")).prependTo(k), 
                    I(t, (d.isFunction(c) ? c() : c) || Ld, f || j.fit || e.fit, g || j.position || e.position), 
                    d.Fotorama.cache[w] = m.state = "loaded", setTimeout(function() {
                        k.trigger("f:load").removeClass(ab + " " + _a).addClass(bb + " " + (r ? cb : db)), 
                        "stage" === b ? n("load") : (j.thumbratio === $b || !j.thumbratio && e.thumbratio === $b) && (j.thumbratio = u.measures.ratio, 
                        vc());
                    }, 0);
                }
                function q() {
                ...
                if (k) {
                    ...
                    if (!m.$img || h || r) {
                        ...
                        }() : (d.Fotorama.cache[w] = "*", t.on("load", q).on("error", o)), m.state = "", 
                        s.src = w;
                    }
                }
            });
        ...
        function lb(a, b) {
            ca(a, b, function(a, c, e, f, g, h) {
                if (!f) {
                    ...
                    var i = f[0];
                    "stage" === b ? (e.html && d('<div class="' + kb + '"></div>').append(e._html ? d(e.html).removeAttr("id").html(e._html) : e.html).appendTo(f), 
                    e.caption && d(N(ob, N(pb, e.caption))).appendTo(f), e.video && f.addClass(za).append(Fd.clone()), 
                    X(i, function() {
                        setTimeout(function() {
                            Q(rd);
                        }, 0), pc({
                    ...
                    }), td = td.add(f)) : "navDot" === b ? (eb(i), Ad = Ad.add(f)) : "navThumb" === b && (eb(i), 
                    h.$wrap = f.children(":first"), Bd = Bd.add(f), e.video && h.$wrap.append(Fd.clone()));
                }
            });
        }
        function sb(a, b, c, d) {
        ...
        function tb(a) {
            ca(a, "stage", function(a, b, c, f, g, h) {
                if (f) {
                    ...
                    }, Sc && l(0))), F(f[0]) && (f.appendTo(sd), mc(c.$video)), sb(h.$img, Ld, j, k), 
                    sb(h.$full, Ld, j, k);
                }
            });
        }
        function ub(a, b) {
            if ("thumbs" === Nc && !isNaN(a)) {
                ...
                Bd.each(function() {
                    ...
                    }, j = i(), k = yc[h] || {}, l = k.thumbfit || e.thumbfit, m = k.thumbposition || e.thumbposition;
        ...
        function wb(a, b, c) {
            if (!wb[c]) {
                ...
                b.append(a.filter(function() {
                    ...
                    if (f) {
                        var a = d(this), b = a.data(), c = Math.round(Uc * b.data.thumbratio) || Tc;
                        b.l = g, b.w = c, a.css({
                            width: c
                        }), g += c + e.thumbmargin;
                    }
        ...
        function Rb(a) {
            ...
            if (b) {
                var c = Od.min !== Od.max, d = a.minMax || c && Lb(Dc[hd]), e = c && (a.keep && Rb.l ? Rb.l : h((a.coo || Ld.nw / 2) - Lb(b).c, d.min, d.max)), f = c && h(e, Od.min, Od.max), g = 1.1 * a.time;
                _(zd, {
                    time: g,
                    pos: f || 0,
                    onEnd: function() {
        ...
        function cc(a) {
            Fc = Gc = Jd;
            var b = Dc[Xb];
            b && (_b(Xb), Qd[Xb].push(b.addClass(Wa)), a || id.show.onEnd(!0), v(sd, 0, !0), 
            bc(Xb), tb(Ec), $(), ba());
        }
        function ec(a, b) {
        ...
        function jc() {
            if (clearTimeout(jc.t), G.stop(jc.w), !e.autoplay || cd) return void (id.autoplay && (id.autoplay = !1, 
            fc("stopautoplay")));
            id.autoplay || (id.autoplay = !0, fc("startautoplay"));
            var a = Jd, b = Dc[Xb].data();
            jc.w = G(function() {
                return b.state || a !== Jd;
            }, function() {
                jc.t = setTimeout(function() {
                    if (!cd && a === Jd) {
                        var b = Kc, c = yc[b][Xb].data();
                        jc.w = G(function() {
                            return c.state || b !== Kc;
                        }, function() {
        ...
        function kc() {
            id.fullScreen && (id.fullScreen = !1, Kb && vb.cancel(ld), Db.removeClass(ja), Cb.removeClass(ja), 
            a.removeClass(Za).insertAfter(pd), Ld = d.extend({}, ed), mc(Cc, !0, !0), rc("x", !1), 
            id.resize(), Pa(Ec, "stage"), Q(Eb, ad, _c), fc("fullscreenexit"));
        }
        function lc(a, b) {
            Xc && (a.removeClass(Ua + " " + Va), b && !Cc && a.addClass(b.replace(/^|\s/g, " " + Ta + "--")));
        }
        function mc(a, b, c) {
            b && (qd.removeClass(na), Cc = !1, o()), a && a !== Cc && (a.remove(), fc("unloadvideo")), 
            c && (ic(), jc());
        }
        function nc(a) {
            qd.toggleClass(qa, a);
        ...
        function oc(a) {
            if (!Md.flow) {
                var b = a ? a.pageX : oc.x, c = b && !yb(xb(b)) && e.click;
        ...
        function qc(a, b) {
            ...
            f.hasClass(mb) ? id.playVideo() : c === Ed ? id.toggleFullScreen() : Cc ? c === Hd && mc(Cc, !0, !0) : b ? nc() : e.click && pc({
        ...
        function vc() {
            if (m(), u(), !vc.i) {
                vc.i = !0;
                var a = e.startindex;
                (a || e.hash && c.hash) && (Lc = L(a || c.hash.replace(/^#/, ""), yc, 0 === id.index || a, a)), 
                Jd = Fc = Gc = Hc = Lc = z(Lc) || 0;
            }
            if (zc) {
                if (wc()) return;
        ...
        Cb = d("html"), Db = d("body");
        var yc, zc, Ac, Bc, Cc, Dc, Ec, Fc, Gc, Hc, Ic, Jc, Kc, Lc, Mc, Nc, Oc, Pc, Qc, Rc, Sc, Tc, Uc, Vc, Wc, Xc, Yc, Zc, $c, _c, ad, bd, cd, dd, ed, fd, gd, hd, id = this, jd = d.now(), kd = ia + jd, ld = a[0], md = 1, nd = a.data(), od = d("<style></style>"), pd = d(N(Ya)), qd = d(N(ka)), rd = d(N(xa)).appendTo(qd), sd = (rd[0], 
        d(N(Aa)).appendTo(rd)), td = d(), ud = d(N(Da + " " + Fa + rb)), vd = d(N(Da + " " + Ga + rb)), wd = ud.add(vd).appendTo(rd), xd = d(N(Ia)), yd = d(N(Ha)).appendTo(xd), zd = d(N(Ja)).appendTo(yd), Ad = d(), Bd = d(), Cd = (sd.data(), 
        zd.data(), d(N(jb)).appendTo(zd)), Dd = d(N($a + rb)), Ed = Dd[0], Fd = d(N(mb)), Gd = d(N(nb)).appendTo(rd), Hd = Gd[0], Id = d(N(qb)), Jd = !1, Kd = {}, Ld = {}, Md = {}, Nd = {}, Od = {}, Pd = {}, Qd = {}, Rd = {}, Sd = 0, Td = [];
        qd[Xb] = d(N(ya)), qd[Zb] = d(N(Ma + " " + Oa + rb, N(ib))), qd[Yb] = d(N(Ma + " " + Na + rb, N(hb))), 
        Qd[Xb] = [], Qd[Zb] = [], Qd[Yb] = [], Rd[Xb] = {}, qd.addClass(Ib ? ma : la).toggleClass(qa, !e.controlsonstart), 
        nd.fotorama = this, id.startAutoplay = function(a) {
            return id.autoplay ? this : (cd = dd = !1, t(a || e.autoplay), jc(), this);
        }, id.stopAutoplay = function() {
            return id.autoplay && (cd = dd = !0, jc()), this;
        }, id.show = function(a) {
            var b;
            "object" != typeof a ? (b = a, a = {}) : b = a.index, b = ">" === b ? Gc + 1 : "<" === b ? Gc - 1 : "<<" === b ? 0 : ">>" === b ? zc - 1 : b, 
            b = isNaN(b) ? L(b, yc, !0) : b, b = "undefined" == typeof b ? Jd || 0 : b, id.activeIndex = Jd = z(b), 
            Ic = E(Jd), Jc = U(Jd), Kc = x(Jd + (Yc ? -1 : 1)), Ec = [ Jd, Ic, Jc ], Gc = Mc ? b : Jd;
            var c = Math.abs(Hc - Gc), d = w(a.time, function() {
            ...
            var i = g === Dc && !a.user;
            mc(Cc, Dc.i !== yc[x(Fc)].i), lb(Ec, "stage"), tb(Mb ? [ Gc ] : [ Gc, E(Gc), U(Gc) ]), 
            rc("go", !0), i || fc("show", {
                user: a.user,
                time: d
            }), cd = !0;
            ...
            if (Sc) {
                var k = Dc[Xb], l = Jd !== Hc ? yc[Hc][Xb] : null;
                aa(k, l, td, {
                    time: d,
                    method: e.transition,
                    onEnd: j
            ...
            if (Gb(), Nc) {
                ...
                Rb({
                    time: d,
                    coo: m !== Jd && a.coo,
                    guessIndex: "undefined" != typeof a.coo ? m : Jd,
                    keep: i
                }), Oc && Ob(d);
            }
            return bd = "undefined" != typeof Hc && Hc !== Jd, Hc = Jd, e.hash && bd && !id.eq && H(Dc.id || Jd + 1), 
            this;
        }, id.requestFullScreen = function() {
            return Qc && !id.fullScreen && (_c = Eb.scrollTop(), ad = Eb.scrollLeft(), Q(Eb), 
            rc("x", !0), ed = d.extend({}, Ld), a.addClass(Za).appendTo(Db.addClass(ja)), Cb.addClass(ja), 
            mc(Cc, !0, !0), id.fullScreen = !0, Rc && vb.request(ld), id.resize(), Pa(Ec, "stage"), 
            Sa(), fc("fullscreenenter")), this;
            ...
            var d = Ld.width, f = Ld.height, g = Ld.ratio, i = Eb.height() - (Nc ? yd.height() : 0);
            return q(d) && (qd.addClass(ua).css({
                width: d,
                minWidth: Ld.minwidth || 0,
                maxWidth: Ld.maxwidth || ac
            }), d = Ld.W = Ld.w = qd.width(), Ld.nw = Nc && p(e.navwidth, d) || d, e.glimpse && (Ld.w -= Math.round(2 * (p(e.glimpse, d) || 0))), 
            sd.css({
                width: Ld.w,
                marginLeft: (Ld.W - Ld.w) / 2
            }), f = p(f, i), f = f || g && d / g, f && (d = Math.round(d), f = Ld.h = Math.round(h(f, p(Ld.minheight, i), p(Ld.maxheight, i))), 
            rd.stop().animate({
                width: d,
                height: f
            }, b, function() {
            ...
            return id.cancelFullScreen(), id.stopAutoplay(), yc = id.data = null, j(), Ec = [], 
            bc(Xb), vc.ok = !1, this;
        }, id.playVideo = function() {
            var a = Dc, b = a.video, c = Jd;
            return "object" == typeof b && a.videoReady && (Rc && id.fullScreen && id.cancelFullScreen(), 
            G(function() {
                return !vb.is() || c !== Jd;
            }, function() {
                c === Jd && (a.$video = a.$video || d(d.Fotorama.jst.video(b)), a.$video.appendTo(a[Xb]), 
                qd.addClass(na), Cc = a.$video, o(), wd.blur(), Dd.blur(), fc("loadvideo"));
            })), this;
            ...
            onEnd: function(a) {
                ...
                if (a.moved) a.pos !== a.newPos ? (cd = !0, _(zd, {
                    ...
                    overPos: a.overPos,
                    onEnd: b
                }), ub(a.newPos), Xc && lc(yd, K(a.newPos, Od.min, Od.max))) : b(); else {
            ...
            id[b] = function() {
                return yc = yc || [], "load" !== b ? Array.prototype[b].apply(yc, arguments) : arguments[0] && "object" == typeof arguments[0] && arguments[0].length && (yc = P(arguments[0])), 
                vc(), id;
            };
        }), vc();
    ...
    d.Fotorama = d.Fotorama || {}, d.Fotorama.jst = d.Fotorama.jst || {}, d.Fotorama.jst.style = function(a) {
        ...
        var c = "", d = (tb.escape, Array.prototype.join);
...
}(window, document, location, "undefined" != typeof jQuery && jQuery), function(a) {
    var b = function(b, c, d, e) {
        ...
        _setup_nav: function(b) {
            ...
            }), d.settings.showHeadline ? f.append(e.append(c).append(g)) : f.append(e.append(g)), 
            d.nav = f;
        },
        ...
        _setup_pos: function() {
            var b = d.nav, c = a(window).height(), e = b.offset().top;
            a.each(d.sections.data, function() {
                var b = a("#" + this.id), c = b.height();
        ...
        _check_pos: function() {
            var b = d.nav, c = a(window).scrollTop(), e = c + d.settings.scrollOffset, f = c + d.dims.vp_height - d.settings.scrollOffset, g = [];
        ...
        init: function(e) {
            return this.each(function() {
                ...
                b(c()), d.settings.onRender && d.settings.onRender.call(this)) : (console.log('Build failed, scrollNav could not find "' + d.settings.insertTarget + '"'), 
    ...
    d = function(a, b) {
        ...
        function b(b, e) {
            this.handler = b, this.columns = this.containerWidth = this.resizeTimer = null, 
            this.activeItemCount = 0, this.itemHeightsDirty = !0, this.placeholders = [], a.extend(!0, this, c, e), 
            this.update = d(this.update, this), this.onResize = d(this.onResize, this), this.onRefresh = d(this.onRefresh, this), 
            this.getItemWidth = d(this.getItemWidth, this), this.layout = d(this.layout, this), 
            this.layoutFull = d(this.layoutFull, this), this.layoutColumns = d(this.layoutColumns, this), 
            this.filter = d(this.filter, this), this.clear = d(this.clear, this), this.getActiveItems = d(this.getActiveItems, this), 
            this.refreshPlaceholders = d(this.refreshPlaceholders, this), this.sortElements = d(this.sortElements, this);
            for (var f, g, h, i = 0, j = 0, k = 0, l = {}; b.length > i; i++) if (g = b.eq(i), 
            f = g.data("filterClass"), "object" == typeof f && f.length > 0) for (j = 0; f.length > j; j++) h = a.trim(f[j]).toLowerCase(), 
            h in l || (l[h] = []), l[h].push(g[0]);
            for (var m = this.possibleFilters; m.length > k; k++) {
                var n = a.trim(m[k]).toLowerCase();
                n in l || (l[n] = []);
            }
            this.filterClasses = l, this.autoResize && a(window).bind("resize.wookmark", this.onResize), 
            this.container.bind("refreshWookmark", this.onRefresh);
        }
        return b.prototype.update = function(b) {
            this.itemHeightsDirty = !0, a.extend(!0, this, b);
        }, b.prototype.onResize = function() {
            clearTimeout(this.resizeTimer), this.itemHeightsDirty = 0 !== this.flexibleWidth, 
            ...
            if (b = b || [], c = c || "or", b.length) {
                for (e = 0; b.length > e; e++) h = a.trim(b[e].toLowerCase()), h in this.filterClasses && i.push(this.filterClasses[h]);
                if (d = i.length, "or" == c || 1 == d) for (e = 0; d > e; e++) j = j.add(i[e]); else if ("and" == c) {
                    var k, l, m, n = i[0], o = !0;
                    for (e = 1; d > e; e++) i[e].length < n.length && (n = i[e]);
                    for (n = n || [], e = 0; n.length > e; e++) {
                        for (l = n[e], o = !0, f = 0; i.length > f && o; f++) if (m = i[f], n != m) {
            ...
            for (var d, e, f, g, h, i, j = this.placeholders.length, k = this.columns.length, l = this.container.innerHeight(); k > j; j++) d = a('<div class="wookmark-placeholder"/>').appendTo(this.container), 
            this.placeholders.push(d);
            for (i = this.offset + 2 * parseInt(this.placeholders[0].css("borderWidth"), 10), 
            j = 0; this.placeholders.length > j; j++) if (d = this.placeholders[j], f = this.columns[j], 
            j >= k || !f[f.length - 1]) d.css("display", "none"); else {
                if (e = f[f.length - 1], !e) continue;
                h = e.data("wookmark-top") + e.data("wookmark-height") + this.offset, g = l - h - i, 
                d.css({
                    position: "absolute",
            ...
            var a = this.itemWidth, b = this.container.width() - 2 * this.outerOffset, c = this.handler.eq(0), d = this.flexibleWidth;
            if (void 0 === this.itemWidth || 0 === this.itemWidth && !this.flexibleWidth ? a = c.outerWidth() : "string" == typeof this.itemWidth && this.itemWidth.indexOf("%") >= 0 && (a = parseFloat(this.itemWidth) / 100 * b), 
            d) {
                "string" == typeof d && d.indexOf("%") >= 0 && (d = parseFloat(d) / 100 * b);
                var e = ~~(.5 + (b + this.offset) / (d + this.offset)), f = Math.min(d, ~~((b - (e - 1) * this.offset) / e));
                a = Math.max(a, f), this.handler.css("width", a);
            }
            return a;
        }, b.prototype.layout = function(a) {
            if (this.container.is(":visible")) {
                var b, c = this.getItemWidth() + this.offset, d = this.container.width(), e = d - 2 * this.outerOffset, f = ~~((e + this.offset) / c), g = 0, h = 0, i = 0, j = this.getActiveItems(), k = j.length;
                ...
                f = Math.max(1, Math.min(f, k)), g = this.outerOffset, "center" == this.align && (g += ~~(.5 + (e - (f * c - this.offset)) >> 1)), 
                this.direction = this.direction || ("right" == this.align ? "right" : "left"), h = a || null === this.columns || this.columns.length != f || this.activeItemCount != k ? this.layoutFull(c, f, g) : this.layoutColumns(c, g), 
                this.activeItemCount = k, this.container.css("height", h), this.fillEmptySpace && this.refreshPlaceholders(c, g), 
            ...
            var e, f, g = 0, h = 0, i = a.makeArray(this.getActiveItems()), j = i.length, k = null, l = null, m = {
                position: "absolute"
            }, n = [], o = "left" == this.align ? !0 : !1;
            for (this.columns = [], i = this.sortElements(i); c > n.length; ) n.push(this.outerOffset), 
            this.columns.push([]);
            for (;j > g; g++) {
                for (e = a(i[g]), k = n[0], l = 0, h = 0; c > h; h++) k > n[h] && (k = n[h], l = h);
                f = d, (l > 0 || !o) && (f += l * b), m[this.direction] = f, m.top = k, e.css(m).data("wookmark-top", k), 
                n[l] += e.data("wookmark-height") + this.offset, this.columns[l].push(e);
            }
            return Math.max.apply(Math, n);
        }, b.prototype.layoutColumns = function(a, b) {
            for (var c, d, e, f, g, h = [], i = 0, j = 0; this.columns.length > i; i++) {
                for (h.push(this.outerOffset), d = this.columns[i], g = i * a + b, c = h[i], j = 0; d.length > j; j++) e = d[j], 
                f = {
                    top: c
            ...
            clearTimeout(this.resizeTimer), a(window).unbind("resize.wookmark", this.onResize), 
            this.container.unbind("refreshWookmark", this.onRefresh);
        }, b;
    }(), a.fn.wookmark = function(a) {
        return this.wookmarkInstance ? this.wookmarkInstance.update(a || {}) : this.wookmarkInstance = new b(this, a || {}), 
    ...
    a.fn.slabText = function(b) {
        ...
        return a("body").addClass("slabtexted"), this.each(function() {
            b && a.extend(c, b);
            var d = a(this), e = a("span.slabtext", d).length, f = e ? [] : String(a.trim(d.text())).replace(/\s{2,}/g, " ").split(" "), g = null, h = null, i = c.fontRatio, j = c.forceNewCharCount, k = c.headerBreakpoint, l = c.viewportBreakpoint, m = c.postTweak, n = c.precision, o = c.resizeThrottleTime, p = c.minCharsPerLine, q = null, r = a(window).width(), s = d.find("a:first").attr("href") || d.attr("href"), t = s ? d.find("a:first").attr("title") : "";
            if (!(!e && p && f.join(" ").length < p)) {
                var u = function() {
                    var a = jQuery('<div style="display:none;font-size:1em;margin:0;padding:0;height:auto;line-height:1;border:0;">&nbsp;</div>').appendTo(d), b = a.height();
                    return a.remove(), b;
                }, v = function() {
                    var b, o = d.width();
                    if (0 !== o) {
                        if (d.removeClass("slabtextdone slabtextinactive"), l && l > r || k && k > o) return void d.addClass("slabtextinactive");
                        if (b = u(), e || !j && b == g) g = b; else {
                            g = b;
                            var q, v, w, x = Math.min(60, Math.floor(o / (g * i))), y = 0, z = [], A = "", B = "", C = "";
                            if (x != h) {
                                for (h = x; y < f.length; ) {
                                    for (B = ""; B.length < h && (A = B, B += f[y] + " ", !(++y >= f.length)); ) ;
                                    p && (q = f.slice(y).join(" "), q.length < p && (B += q, A = B, y = f.length + 2)), 
                                    v = h - A.length, w = B.length - h, w > v && A.length >= (p || 2) ? (C = A, y--) : C = B, 
                                    C = a("<div/>").text(C).html(), c.wrapAmpersand && (C = C.replace(/&amp;/g, '<span class="amp">&amp;</span>')), 
                                    C = a.trim(C), z.push('<span class="slabtext">' + C + "</span>");
                                }
                                d.html(z.join(" ")), s && d.wrapInner('<a href="' + s + '" ' + (t ? 'title="' + t + '" ' : "") + "/>");
                            }
                        }
                        a("span.slabtext", d).each(function() {
                            var b, d, e, f = a(this), h = f.text(), i = h.split(" ").length > 1;
                            m && f.css({
                                "word-spacing": 0,
                                "letter-spacing": 0
                            }), d = o / f.width(), e = parseFloat(this.style.fontSize) || g, f.css("font-size", Math.min((e * d).toFixed(n), c.maxFontSize) + "px"), 
                            b = m ? o - f.width() : !1, b && f.css((i ? "word" : "letter") + "-spacing", (b / (i ? h.split(" ").length - 1 : h.length)).toFixed(n) + "px");
    ...
    a.fn.parallax = function(b) {
        var c = a(window).height(), d = a.extend({
            speed: .1
        }, b);
        return this.each(function() {
            var b = a(this);
            a(document).scroll(function() {
                var e = a(window).scrollTop(), f = b.offset().top, g = b.parent().outerHeight();
                if (!(e >= f + g || f >= e + c)) {
                    var h = Math.round((f - e) * d.speed);
                    b.css({
    ...
    e.prototype = {
        ...
        _setupRows: function(b, c) {
            if (c.layout) this.layout = c.layout; else if (a(b).attr("data-layout")) this.layout = a(b).attr("data-layout"); else {
        ...
        _setupColumns: function(c, d) {
            var e = this, f = function(e) {
                ...
                d.highresLinks ? (h.each(function() {
                    var b;
                    b = a(this).attr("data-highres") ? a(this).attr("data-highres") : a(this).attr("src"), 
                    a(this).wrapAll('<a href="' + b + '" class="photoset-cell highres-link" />');
    ...
    a.fn.imagesLoaded = function(b) {
        ...
        function f(b, d) {
            b.src !== h && -1 === a.inArray(b, l) && (l.push(b), d ? n.push(b) : m.push(b), 
            a.data(b, "imagesLoaded", {
                isBroken: d,
                src: b.src
            }), j && i.notifyWith(a(b), [ d, k, a(m), a(n) ]), k.length === l.length && (setTimeout(c), 
            k.unbind(".imagesLoaded", e)));
        }
        ...
        return a.isPlainObject(b) && a.each(b, function(a, c) {
            ...
            return g && g.src === e ? void f(c, g.isBroken) : c.complete && c.naturalWidth !== d ? void f(c, 0 === c.naturalWidth || 0 === c.naturalHeight) : void ((c.readyState || c.complete) && (c.src = h, 
            c.src = e));
        }) : c(), i ? i.promise(g) : g;
    };
    ...
    i = l.special.throttledresize = {
        ...
        handler: function(b, c) {
            ...
            j = !0, k || (setInterval(function() {
                n++, (n > i.threshold && j || c) && (b.type = "throttledresize", l.dispatch.apply(d, e), 
                j = !1, n = 0), n > 9 && (a(m).stop(), k = !1, n = 0);
            }, 30), k = !0);
        },
        threshold: 0
    };
    ...
    function d(a, b, c) {
        for (var e, f = 0; e = a[f]; f++) g.matchesSelector(e, b.selector) && -1 == b.firedElems.indexOf(e) && (b.firedElems.push(e), 
        c.push({
            callback: b.callback,
            elem: e
    ...
    function f(a) {
        a.arrive = i.bindEvent, g.addMethod(a, "unbindArrive", i.unbindEvent), g.addMethod(a, "unbindArrive", i.unbindEventWithSelectorOrCallback), 
        g.addMethod(a, "unbindArrive", i.unbindEventWithSelectorAndCallback), a.leave = j.bindEvent, 
        g.addMethod(a, "unbindLeave", j.unbindEvent), g.addMethod(a, "unbindLeave", j.unbindEventWithSelectorOrCallback), 
        g.addMethod(a, "unbindLeave", j.unbindEventWithSelectorAndCallback);
    }
    var g = function() {
        ...
        return a.prototype.addEvent = function(a, b, c, d) {
            ...
            for (var b, c = this._eventsBucket.length - 1; b = this._eventsBucket[c]; c--) a(b) && (this._beforeRemoving && this._beforeRemoving(b), 
    ...
    c = function(b, c, d) {
        ...
        return f.beforeAdding(function(c) {
            var e, f = c.target;
            (f === a.document || f === a) && (f = document.getElementsByTagName("html")[0]), 
            ...
            f.removeEvent("function" == typeof a ? function(c) {
                for (var d = 0; d < b.length; d++) if (c.target === b[d] && c.callback === a) return !0;
                return !1;
            } : function(c) {
                for (var d = 0; d < b.length; d++) if (c.target === b[d] && c.selector === a) return !0;
                return !1;
            });
        }, this.unbindEventWithSelectorAndCallback = function(a, b) {
            var c = e(this);
            f.removeEvent(function(d) {
                for (var e = 0; e < c.length; e++) if (d.target === c[e] && d.selector === a && d.callback === b) return !0;
                return !1;
            });
        }, this;
    };
    var i = new c(function(a) {
        ...
        a.forEach(function(a) {
            var c = a.addedNodes, f = a.target, h = [];
            null !== c && 0 < c.length ? d(c, b, h) : "attributes" === a.type && g.matchesSelector(f, b.selector) && -1 == b.firedElems.indexOf(f) && (b.firedElems.push(f), 
            h.push({
                callback: b.callback,
                elem: f
            })), e(h);
    ...
    b && f(b.fn), f(HTMLElement.prototype), f(NodeList.prototype), f(HTMLCollection.prototype), 
    f(HTMLDocument.prototype), f(Window.prototype);
}(this, "undefined" == typeof jQuery ? null : jQuery), jQuery(document).ready(function() {
    jQuery(".aesop-lightbox").swipebox(), jQuery(".aesop-video-container").fitVids(), 
    jQuery(function() {
    ...
    jQuery(".aesop-toggle-chapter-menu").click(function(a) {
        ...
        b.preventDefault(), a();
    }), jQuery(".aesop-chapter-menu-open article").live("click", function(b) {
        b.preventDefault(), a();
